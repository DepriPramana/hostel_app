...
class ByFacilitiesRooms extends StatefulWidget {

  final ChangeThemeState state;

  ByFacilitiesRooms(this.state);

  @override
  _ByFacilitiesRoomsState createState() => _ByFacilitiesRoomsState();
}

class _ByFacilitiesRoomsState extends State<ByFacilitiesRooms> {
  ...
  Future fetchByPlaceHostels() async {
    Query reference =
    await FirebaseDatabase.instance.reference().child("Hostels").orderByChild("hostel_facilities");
        ...
        Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text("Rooms By Facilities",
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(
                            _hostelList[index].hostel_facilities,
