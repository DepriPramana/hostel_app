...
class ScrollingRooms extends StatefulWidget {

  final ChangeThemeState state;
  final List<Hostels> data;
  final int index;

  ScrollingRooms(this.state, this.data, this.index);

  @override
  _ScrollingRoomsState createState() => _ScrollingRoomsState();
}

class _ScrollingRoomsState extends State<ScrollingRooms> {
